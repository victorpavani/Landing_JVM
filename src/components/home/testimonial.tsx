...
const Testimonial: FC = () => {
  return (
    <Box id="testimonial" sx={{ py: { xs: 10, md: 14 }, backgroundColor: 'background.paper' }}>
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/images/iphone.png" width={650} height={678} quality={97} alt="Feature img" />
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Serviços pensados para crescimento do seu negócio.
            </Typography>
